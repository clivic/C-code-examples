...
// 描述:	载入位图(调用上面的代码)并转换成纹理
{
	...
	bool load1 = TextureImage[0] = LoadBMP("cr0.bmp");
	bool load2 = TextureImage[1] = LoadBMP("cr1.bmp");
	bool load3 = TextureImage[2] = LoadBMP("cr2.bmp");
	bool load4 = TextureImage[3] = LoadBMP("cr3.bmp");
	bool load5 = TextureImage[4] = LoadBMP("cr4.bmp");
	bool load6 = TextureImage[5] = LoadBMP("cr5.bmp");
	bool load7 = TextureImage[6] = LoadBMP("cr5.bmp");
...
// 描述:	从这里开始进行所有的绘制
{
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3f(-4.0f, -1.0f, -6.5f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(4.0f, -1.0f, -6.5f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(4.0f, 2.0f, -6.5f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(-4.0f, 2.0f, -6.5f);
	glEnd();
	...
	glTexCoord2f(0.0f, 1.0f); glVertex3f(-4.0f, 2.0f, 6.5f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(-4.0f, 2.0f, -6.5f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(4.0f, 2.0f, -6.5f);
	glTexCoord2f(1.0f, 1.0f); glVertex3f(4.0f, 2.0f, 6.5f);
	glEnd();
	...
	glTexCoord2f(1.0f, 1.0f); glVertex3f(4.0f, -1.0f, -6.5f);
	glTexCoord2f(0.0f, 1.0f); glVertex3f(-4.0f, -1.0f, -6.5f);
	glTexCoord2f(0.0f, 0.0f); glVertex3f(-4.0f, -1.0f, 6.5f);
	glTexCoord2f(1.0f, 0.0f); glVertex3f(4.0f, -1.0f, 6.5f);
	glEnd();
