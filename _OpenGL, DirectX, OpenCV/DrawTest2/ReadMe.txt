...
res\Toolbar.bmp
    ...
    初始工具列和狀態列會在 CMainFrame 類別中建構。請使用資源編輯器編輯這個工具列點陣圖，並更新 DrawTest2.rc 中的 IDR_MAINFRAME TOOLBAR 陣列，以加入工具列按鈕。
/////////////////////////////////////////////////////////////////////////////

應用程式精靈會建立一個文件類型及一個檢視表：

DrawTest2Doc.h、DrawTest2Doc.cpp - 文件
    這些檔案包含您的 CDrawTest2Doc 類別。編輯這些檔案，可加入您的特殊文件類型並實作檔案儲存和載入 (透過 CDrawTest2Doc::Serialize)。

DrawTest2View.h、DrawTest2View.cpp - 文件的檢視表
    這些檔案包含您的 CDrawTest2View 類別。
    CDrawTest2View 物件是用來檢視 CDrawTest2Doc 物件。
...
StdAfx.h, StdAfx.cpp
    這些檔案是用來建置名為 DrawTest2.pch 的先行編譯標頭 (PCH) 檔，以及名為 StdAfx.obj 的先行編譯型別檔。
