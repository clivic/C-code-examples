...
//	3. improved Insert function, which can insert a node only by giving the containing of the node.
//	4. added a new version of GetItem function called GetItem_change which set the head pointer to
//	   the current found node besides the same thing done as GetItem function.
//*************************************************************************************************
#ifndef CL
#define CL
