...
//	Updates(from version 1.0):	(!!!can't be use for unknown errors)
//		It adds the class OrderedList, which demands List_entry to be
//		overloaded ==, !=, >, <, >=, <=, to make the list always in
//		order.
