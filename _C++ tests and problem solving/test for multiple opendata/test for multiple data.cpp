/**************************************************************************************************
This program tests the validity of open difeerent data by different ifstream variables,
we use the module of "some exercises in Chapter6", and test it.
**************************************************************************************************/
...
//	Result:
//	It's improper to ignore function "clear()", the reason is in the execution...
