...
MIDL_DEFINE_GUID(IID, DIID_ISubFootPrintECNU,0xAD9EC178,0x95AC,0x4A49,0xB1,0xF2,0x15,0xDD,0x03,0x90,0x5F,0x22);


MIDL_DEFINE_GUID(CLSID, CLSID_SubFootPrintECNU,0x13F71C93,0xA6CD,0x48C1,0x91,0xF3,0x17,0x5D,0xD9,0x2A,0x82,0xB7);
