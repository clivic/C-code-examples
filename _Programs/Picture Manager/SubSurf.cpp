...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 0);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 1);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 2);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 3);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 4);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 5);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 6);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 7);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 8);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 9);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 10);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 11);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 12);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 13);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 14);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 15);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 16);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 17);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 18);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 19);
	getOnePic.DoModal();
}
...
{ 
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 20);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 21);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 22);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 23);
	getOnePic.DoModal();
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubGetOnePic getOnePic(NULL, picListptr, currentPage*numInPages + 24);
	getOnePic.DoModal();
}
