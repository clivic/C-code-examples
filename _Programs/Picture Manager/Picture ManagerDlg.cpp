...
void CPictureManagerDlg::OnPaint()
{
	...
	else
	{
		...
		dc.StretchBlt(BACKGROUND_ST_X, BACKGROUND_ST_Y, bitmap.bmWidth, bitmap.bmWidth, &dcMem,
			0, 0, bitmap.bmWidth, bitmap.bmWidth, SRCCOPY);
		//----结束
...
{
	// TODO:  在此添加控件通知处理程序代码
	CSubAddNewPic dlgSubAddNewPic(NULL, &picLibrary);
	dlgSubAddNewPic.DoModal(); //打開子框
}
...
{
	// TODO:  在此添加控件通知处理程序代码
	//CSubFootPrintECNU dlgFootPrint(NULL, &picLibrary);
