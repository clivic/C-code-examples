...
const unsigned int BLEN = 16;		// blanks of printing results
...
public:
	...
	void SetPntyAI(const Personality &d);
...
protected:
	// data members
	Player leftP;			// Player 1, in PVE, it represents the person
	Player rightP;			// Player 2, in PVE, it represents the computer
	Mode mode = PVE;
	Personality pntyAI = DEFAULT;
	...
	void AnnounceWinnerCmd(const string &str);
	void PrintRevCmd();
};
